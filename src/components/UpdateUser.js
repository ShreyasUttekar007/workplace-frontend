...
const UpdateUser = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.put(`${API_URL}/auth/update-user/${userId}`, {
        userName,
        email,
        roles,
        location,
  ...
  const roleApOptions = [
    ...
    { value: "6-Amadalavalasa", label: "6-Amadalavalasa" },
    { value: "7-Etcherla", label: "7-Etcherla" },
    { value: "1-Ichapuram", label: "1-Ichapuram" },
    { value: "8-Narasannapeta", label: "8-Narasannapeta" },
    { value: "10-Palakonda", label: "10-Palakonda" },
    { value: "2-Palasa", label: "2-Palasa" },
    { value: "4-Pathapatnam", label: "4-Pathapatnam" },
    { value: "9-Rajam", label: "9-Rajam" },
    { value: "5-Srikakulam", label: "5-Srikakulam" },
    { value: "3-Tekkali", label: "3-Tekkali" },
    { value: "14-Bobbili", label: "14-Bobbili" },
    { value: "15-Cheepurupalli", label: "15-Cheepurupalli" },
    { value: "16-Gajapathinagaram", label: "16-Gajapathinagaram" },
    { value: "11-Kurupam", label: "11-Kurupam" },
    { value: "17-Nellimarla", label: "17-Nellimarla" },
    { value: "12-Parvathipuram", label: "12-Parvathipuram" },
    { value: "13-Salur", label: "13-Salur" },
    { value: "19-Srungavarapukota", label: "19-Srungavarapukota" },
    { value: "18-Vizianagaram", label: "18-Vizianagaram" },
    { value: "30-Anakapalli", label: "30-Anakapalli" },
    { value: "28-Araku Valley", label: "28-Araku Valley" },
    { value: "20-Bhimili", label: "20-Bhimili" },
    { value: "26-Chodavaram", label: "26-Chodavaram" },
    { value: "32-Elamanchili", label: "32-Elamanchili" },
    { value: "25-Gajuwaka", label: "25-Gajuwaka" },
    { value: "27-Madugula", label: "27-Madugula" },
    { value: "34-Narsipatnam", label: "34-Narsipatnam" },
    { value: "29-Paderu", label: "29-Paderu" },
    { value: "33-Payakaraopeta", label: "33-Payakaraopeta" },
    { value: "31-Pendurthi", label: "31-Pendurthi" },
    { value: "21-Visakhapatnam East", label: "21-Visakhapatnam East" },
    { value: "23-Visakhapatnam North", label: "23-Visakhapatnam North" },
    { value: "22-Visakhapatnam South", label: "22-Visakhapatnam South" },
    { value: "24-Visakhapatnam West", label: "24-Visakhapatnam West" },
    { value: "44-Amalapuram", label: "44-Amalapuram" },
    { value: "40-Anaparthy", label: "40-Anaparthy" },
    { value: "46-Gannavaram (Eg)", label: "46-Gannavaram (Eg)" },
    { value: "52-Jaggampeta", label: "52-Jaggampeta" },
    { value: "41-Kakinada City", label: "41-Kakinada City" },
    { value: "38-Kakinada Rural", label: "38-Kakinada Rural" },
    { value: "47-Kothapeta", label: "47-Kothapeta" },
    { value: "48-Mandapeta", label: "48-Mandapeta" },
    { value: "43-Mummidivaram", label: "43-Mummidivaram" },
    { value: "39-Peddapuram", label: "39-Peddapuram" },
    { value: "37-Pithapuram", label: "37-Pithapuram" },
    { value: "36-Prathipad", label: "36-Prathipad" },
    { value: "50-Rajahmundry City", label: "50-Rajahmundry City" },
    { value: "51-Rajahmundry Rural", label: "51-Rajahmundry Rural" },
    { value: "49-Rajanagaram", label: "49-Rajanagaram" },
    { value: "42-Ramachandrapuram", label: "42-Ramachandrapuram" },
    { value: "53-Rampachodavaram", label: "53-Rampachodavaram" },
    { value: "45-Razole", label: "45-Razole" },
    { value: "35-Tuni", label: "35-Tuni" },
    { value: "56-Achanta", label: "56-Achanta" },
    { value: "59-Bhimavaram", label: "59-Bhimavaram" },
    { value: "68-Chintalapudi", label: "68-Chintalapudi" },
    { value: "64-Dendulur", label: "64-Dendulur" },
    { value: "65-Eluru", label: "65-Eluru" },
    { value: "66-Gopalpuram", label: "66-Gopalpuram" },
    { value: "54-Kovvur", label: "54-Kovvur" },
    { value: "58-Narasapur", label: "58-Narasapur" },
    { value: "55-Nidadavole", label: "55-Nidadavole" },
    { value: "57-Palacole", label: "57-Palacole" },
    { value: "67-Polavaram", label: "67-Polavaram" },
    { value: "62-Tadepalligudem", label: "62-Tadepalligudem" },
    { value: "61-Tanuku", label: "61-Tanuku" },
    { value: "60-Undi", label: "60-Undi" },
    { value: "63-Ungutur", label: "63-Ungutur" },
    { value: "76-Avanigadda", label: "76-Avanigadda" },
    { value: "71-Gannavaram (Krishna)", label: "71-Gannavaram (Krishna)" },
    { value: "72-Gudivada", label: "72-Gudivada" },
    { value: "84-Jaggayyapet", label: "84-Jaggayyapet" },
    { value: "73-Kaikalur", label: "73-Kaikalur" },
    { value: "75-Machilipatnam", label: "75-Machilipatnam" },
    { value: "82-Mylavaram", label: "82-Mylavaram" },
    { value: "83-Nandigama", label: "83-Nandigama" },
    { value: "70-Nuzvid", label: "70-Nuzvid" },
    { value: "77-Pamarru", label: "77-Pamarru" },
    { value: "74-Pedana", label: "74-Pedana" },
    { value: "78-Penamaluru", label: "78-Penamaluru" },
    { value: "69-Tiruvuru", label: "69-Tiruvuru" },
    { value: "80-Vijayawada Central", label: "80-Vijayawada Central" },
    { value: "81-Vijayawada East", label: "81-Vijayawada East" },
    { value: "79-Vijayawada West", label: "79-Vijayawada West" },
    { value: "92-Bapatla", label: "92-Bapatla" },
    { value: "96-Chilakaluripet", label: "96-Chilakaluripet" },
    { value: "95-Guntur East", label: "95-Guntur East" },
    { value: "94-Guntur West", label: "94-Guntur West" },
    { value: "100-Gurzala", label: "100-Gurzala" },
    { value: "101-Macherla", label: "101-Macherla" },
    { value: "87-Mangalagiri", label: "87-Mangalagiri" },
    { value: "97-Narasaraopet", label: "97-Narasaraopet" },
    { value: "85-Peddakurapadu", label: "85-Peddakurapadu" },
    { value: "88-Ponnur", label: "88-Ponnur" },
    { value: "93-Prathipadu", label: "93-Prathipadu" },
    { value: "90-Repalle", label: "90-Repalle" },
    { value: "98-Sattenapalli", label: "98-Sattenapalli" },
    { value: "86-Tadikonda", label: "86-Tadikonda" },
    { value: "91-Tenali", label: "91-Tenali" },
    { value: "89-Vemuru", label: "89-Vemuru" },
    { value: "99-Vinukonda", label: "99-Vinukonda" },
    { value: "105-Addanki", label: "105-Addanki" },
    { value: "106-Chirala", label: "106-Chirala" },
    { value: "103-Darsi", label: "103-Darsi" },
    { value: "112-Giddalur", label: "112-Giddalur" },
    { value: "109-Kandukur", label: "109-Kandukur" },
    { value: "113-Kanigiri", label: "113-Kanigiri" },
    { value: "110-Kondepi", label: "110-Kondepi" },
    { value: "111-Markapur", label: "111-Markapur" },
    { value: "108-Ongole", label: "108-Ongole" },
    { value: "104-Parchur", label: "104-Parchur" },
    { value: "107-Santhanuthalapadu", label: "107-Santhanuthalapadu" },
    { value: "102-Yerragondapalem", label: "102-Yerragondapalem" },
    { value: "115-Atmakur", label: "115-Atmakur" },
    { value: "120-Gudur", label: "120-Gudur" },
    { value: "114-Kavali", label: "114-Kavali" },
    { value: "116-Kovur", label: "116-Kovur" },
    { value: "117-Nellore City", label: "117-Nellore City" },
    { value: "118-Nellore Rural", label: "118-Nellore Rural" },
    { value: "119-Sarvepalli", label: "119-Sarvepalli" },
    { value: "121-Sullurpet", label: "121-Sullurpet" },
    { value: "123-Udayagiri", label: "123-Udayagiri" },
    { value: "122-Venkatagiri", label: "122-Venkatagiri" },
    { value: "124-Badvel", label: "124-Badvel" },
    { value: "131-Jammalamadugu", label: "131-Jammalamadugu" },
    { value: "126-Kadapa", label: "126-Kadapa" },
    { value: "130-Kamalapuram", label: "130-Kamalapuram" },
    { value: "127-Kodur", label: "127-Kodur" },
    { value: "133-Mydukur", label: "133-Mydukur" },
    { value: "132-Proddatur", label: "132-Proddatur" },
    { value: "129-Pulivendla", label: "129-Pulivendla" },
    { value: "125-Rajampet", label: "125-Rajampet" },
    { value: "128-Rayachoty", label: "128-Rayachoty" },
    { value: "146-Adoni", label: "146-Adoni" },
    { value: "134-Allagadda", label: "134-Allagadda" },
    { value: "147-Alur", label: "147-Alur" },
    { value: "140-Banaganapalle", label: "140-Banaganapalle" },
    { value: "141-Dhone", label: "141-Dhone" },
    { value: "143-Kodumur", label: "143-Kodumur" },
    { value: "137-Kurnool", label: "137-Kurnool" },
    { value: "145-Mantralayam", label: "145-Mantralayam" },
    { value: "136-Nandikotkur", label: "136-Nandikotkur" },
    { value: "139-Nandyal", label: "139-Nandyal" },
    { value: "138-Panyam", label: "138-Panyam" },
    { value: "142-Pattikonda", label: "142-Pattikonda" },
    { value: "135-Srisailam", label: "135-Srisailam" },
    { value: "144-Yemmiganur", label: "144-Yemmiganur" },
    { value: "153-Anantapur Urban", label: "153-Anantapur Urban" },
    { value: "160-Dharmavaram", label: "160-Dharmavaram" },
    { value: "150-Guntakal", label: "150-Guntakal" },
    { value: "157-Hindupur", label: "157-Hindupur" },
    { value: "161-Kadiri", label: "161-Kadiri" },
    { value: "154-Kalyandurg", label: "154-Kalyandurg" },
    { value: "156-Madakasira", label: "156-Madakasira" },
    { value: "158-Penukonda", label: "158-Penukonda" },
    { value: "159-Puttaparthi", label: "159-Puttaparthi" },
    { value: "155-Raptadu", label: "155-Raptadu" },
    { value: "148-Rayadurg", label: "148-Rayadurg" },
    { value: "152-Singanamala", label: "152-Singanamala" },
    { value: "151-Tadpatri", label: "151-Tadpatri" },
    { value: "149-Uravakonda", label: "149-Uravakonda" },
    { value: "166-Chandragiri", label: "166-Chandragiri" },
    { value: "172-Chittoor", label: "172-Chittoor" },
    { value: "171-Gangadhara Nellore", label: "171-Gangadhara Nellore" },
    { value: "175-Kuppam", label: "175-Kuppam" },
    { value: "164-Madanpalle", label: "164-Madanpalle" },
    { value: "170-Nagari", label: "170-Nagari" },
    { value: "174-Palamaner", label: "174-Palamaner" },
    { value: "163-Pileru", label: "163-Pileru" },
    { value: "165-Punganur", label: "165-Punganur" },
    { value: "173-Puthalapattu", label: "173-Puthalapattu" },
    { value: "169-Satyavedu", label: "169-Satyavedu" },
    { value: "168-Srikalahasti", label: "168-Srikalahasti" },
    { value: "162-Thamballapalle", label: "162-Thamballapalle" },
    { value: "167-Tirupati", label: "167-Tirupati" },
    { value: "2-Srikakulam", label: "2-Srikakulam" },
    { value: "3-Vizianagaram", label: "3-Vizianagaram" },
    { value: "1-Araku", label: "1-Araku" },
    { value: "4-Visakhapatnam", label: "4-Visakhapatnam" },
    { value: "5-Anakapalli", label: "5-Anakapalli" },
    { value: "7-Amalapuram", label: "7-Amalapuram" },
    { value: "8-Rajahmundry", label: "8-Rajahmundry" },
    { value: "6-Kakinada", label: "6-Kakinada" },
    { value: "9-Narsapuram", label: "9-Narsapuram" },
    { value: "10-Eluru", label: "10-Eluru" },
    { value: "11-Machilipatnam", label: "11-Machilipatnam" },
    { value: "12-Vijayawada", label: "12-Vijayawada" },
    { value: "15-Bapatla", label: "15-Bapatla" },
    { value: "14-Narasaraopet", label: "14-Narasaraopet" },
    { value: "13-Guntur", label: "13-Guntur" },
    { value: "16-Ongole", label: "16-Ongole" },
    { value: "22-Nellore", label: "22-Nellore" },
    { value: "23-Tirupati", label: "23-Tirupati" },
    { value: "21-Kadapa", label: "21-Kadapa" },
    { value: "24-Rajampet", label: "24-Rajampet" },
    { value: "18-Kurnool", label: "18-Kurnool" },
    { value: "17-Nandyal", label: "17-Nandyal" },
    { value: "19-Anantapur", label: "19-Anantapur" },
    { value: "20-Hindupur", label: "20-Hindupur" },
    { value: "25-Chittoor", label: "25-Chittoor" },
    ...
    <div className="container">
      <div className="login">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: "10px" }}>
            <Select
              options={roleApOptions}
              value={roleApOptions.filter((option) =>
                roles.includes(option.value)
              )}
              onChange={handleRoleChange}
              isMulti
          ...
          <div>
            <Select
              options={roleBgOptions}
              value={roleBgOptions.filter((option) =>
                roles.includes(option.value)
              )}
              onChange={handleRoleChange}
              isMulti
