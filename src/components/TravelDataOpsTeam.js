...
import api from "../utils/axiosConfig"; // Adjust path based on your folder structure
            ...
            <tbody>
              {displayedRequests.map((travel) => (
                <tr key={travel._id}>
                  ...
                  <td style={{ textAlign: "center" }}>{travel.travelInstructedBy}</td>
                  <td style={{ textAlign: "center", minWidth: "240px" }}>
                    {travel.eventLocation} - {travel.eventName} - {travel.eventDetails}
                  </td>
...
export default TravelDataOpsTeam;
